...
public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
    {
        ...
        app.UseEndpoints(endpoints =>
        {
            ...
            endpoints.MapControllerRoute("default", "{controller=DashBoards}/{action=Index}/{id?}");
            endpoints.MapControllerRoute("defaultWithArea", "{area}/{controller=DashBoards}/{action=Index}/{id?}");
        });
    }
}
