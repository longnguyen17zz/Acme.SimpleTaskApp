...
namespace Acme.SimpleTaskApp.Web.Controllers
{
	public class OrdersController : SimpleTaskAppControllerBase
	{
		...
		//public async Task<ActionResult> SearchOrder(string keyname)
		//{
		//	var orderItem = await _orderAppService.GetOrderListUser();

		//	List<GetOrderDetailsOutput> filteredOrders;

		//	if (!string.IsNullOrWhiteSpace(keyname))
		//	{
		//		filteredOrders = orderItem
		//				.Where(o =>
		//						(o.Status != null && o.Status.Contains(keyname, StringComparison.OrdinalIgnoreCase))
		//						//(o.CustomerName != null && o.CustomerName.Contains(keyname, StringComparison.OrdinalIgnoreCase))
		//				)
		//				.ToList();
		//	}
		//	else
		...
		//	return View("GetOrderList", filteredOrders);
		//}
