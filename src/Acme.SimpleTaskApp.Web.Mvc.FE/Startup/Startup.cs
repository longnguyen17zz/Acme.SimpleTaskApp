    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
    {
        ...
        app.UseAuthorization();
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                endpoints.MapControllerRoute("default", "{controller=Homepage}/{action=Index}/{id?}");
                endpoints.MapControllerRoute("defaultWithArea", "{area}/{controller=Homepage}/{action=Index}/{id?}");

                // Route mặc định cho admin (không có Area)
